...
public class DividerActivity extends AppCompatActivity {
	...
	public static void startUp(Context context) {
		context.startActivity(new Intent(context, DividerActivity.class));
	}
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.perfect_divider_activity);
		initView();
		initEvent();
		initData();
	}
	...
	private void initView() {
		mListView = (UDLRSlideListView) findViewById(R.id.udls_list_view_divider);
	}
	...
	private void initData() {
		mListView.setAdapter(new DividerAdapter(this, obtainDraggableData()));
